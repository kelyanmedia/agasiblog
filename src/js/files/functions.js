...
export function menuInit() {
  if (document.querySelector(".icon-menu, .hero__burger")) {
    document.addEventListener("click", function (e) {
      if (bodyLockStatus && e.target.closest(".icon-menu, .hero__burger")) {
        bodyLockToggle()
        document.documentElement.classList.toggle("menu-open")
      }
      if (document.querySelector(".menu-open") && !e.target.closest(".menu__body") && bodyLockStatus) {
        bodyLockToggle()
        document.documentElement.classList.toggle("menu-open")
      }
    })
